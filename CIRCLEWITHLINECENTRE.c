...
void circledraw(int xc,int yc,int r)
{
 ...
 void main()
 {
	int x1,y1,r1,x2,y2,r2,x3,y3,r3,x4,y4,r4;
	printf("enter centre and radius of first circle ");
	scanf( "%d %d %d",&x1,&y1,&r1);
	printf("enter centre and radius of circle 2 ");
	scanf("%d %d %d",&x2,&y2,&r2);
	printf("enter centre and radius of circle 3 ");
	scanf("%d %d %d",&x3,&y3,&r3);
	printf("enter centre and radius of circle 4 ");
	scanf("%d %d %d",&x4,&y4,&r4);
